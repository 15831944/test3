...
#define HT_CSP_PIN_CONFIG_ERROR         0x88000069  //CSP的【PIN口令弹出框】配置项错误
...
#define HT_DEVICE_NOT_IDENTIFIED		0xE002000A	//设备不k能识别(复位信息不对)
...
#define HT_KEY_NOT_PRESS				0xE0020019	//用户没有按键
#define HT_KEY_PRESS_CANCEL				0xE002001A	//用户按了取消
